...
2) Написала простейшую страницу с формой,  отправляющей данные методом POST.
...
4) Написала файл db.php где подключила БД и файл save_user где отправила данные с формы и выводом сообщения с успешной или неудачной отправкой данных в БД.
5) Проверила отпраку дынных и написала в форму тестовые данные:
...
6) Нажала отправить -> получила сообщение на странице <img width="1384" height="61" alt="изображение" src="https://github.com/user-attachments/assets/06d5d3d8-e110-450d-aae8-79d829a0582a" /> и данные в бд <img width="562" height="58" alt="изображение" src="https://github.com/user-attachments/assets/0104380a-397a-4718-970b-58a598df5ac0" />
...
Ура! Все работает.
3) Проверяем БД <img width="581" height="93" alt="изображение" src="https://github.com/user-attachments/assets/c2376f9e-bef6-4be7-bbdc-910739d25136" />
